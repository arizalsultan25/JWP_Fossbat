            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="settings">
                        <form class="form-horizontal" method="POST" action="<?= base_url('auth/change_profile') ?>">
                        <div class="form-group row">
                                <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                                <div class="col-sm-10">
                                    <input type="email" required class="form-control" id="inputEmail" placeholder="Email" name="email" value="<?= $this->session->email ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" required class="form-control" id="inputName" placeholder="Name" name="nama" value="<?= $this->session->nama ?>">
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" id="change_password">
                        <form class="form-horizontal" method="POST" action="<?= base_url('auth/change_password') ?>">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" maxlength="12" name="old_password" class="form-control" id="inputName" placeholder="Password Lama">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputName" class="col-sm-2 col-form-label">Password Baru</label>
                                <div class="col-sm-10">
                                    <input type="password" maxlength="12" name="new_password" class="form-control" id="inputName" placeholder="Password Baru">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputName" class="col-sm-2 col-form-label">Konfirmasi Password Baru</label>
                                <div class="col-sm-10">
                                    <input type="password" maxlength="12" name="confirm_password" class="form-control" id="inputName" placeholder="Konfirmasi Password Baru">
                                </div>
                            </div>
