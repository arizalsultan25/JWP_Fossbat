    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="<?= base_url('base/lokasi') ?>">Lokasi Pertandingan</a></li>
        ...
        <?php foreach($lokasi as $row){ ?>
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="<?= base_url('uploads/stadion/'. $row->foto) ?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><?= $row->nama_stadion ?></h4>
                <p><?= $row->alamat ?></p>
                <div class="portfolio-links">
                  <a href="<?= base_url('uploads/stadion/'. $row->foto) ?>" data-gall="portfolioGallery" class="venobox" title="<?= $row->nama_stadion ?>"><i class="bx bx-plus"></i></a>
