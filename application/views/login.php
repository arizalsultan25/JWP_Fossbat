        ...
        <div class="navbar-collapse-header">
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="<?= base_url() ?>">
                <img src="<?= base_url('assets/argon/assets/img/brand/blueaasa.png') ?>">
              </a>
            </div>
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" method="post" action="<?= base_url('index.php/base/proseslogin') ?>">
                ...
                <?php if(isset($this->session->error)){ ?>
                    <span class="text-danger mt-2 mb-2"><?= $this->session->error; ?></span>
                  <?php } ?>
